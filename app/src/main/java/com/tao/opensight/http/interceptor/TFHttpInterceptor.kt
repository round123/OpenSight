...
//import com.tao.opensight.util.HeadUtil
...
//                addQueryParameter("udid", getDeviceSerial()).also { Log.d("RequestLog", "Added udid: ${getDeviceSerial()}") }
...
//            if (!AuthTools.isAuth(request)) {
//                add("udid", getDeviceSerial()).also { Log.d("PostRequestLog", "Added udid: ${getDeviceSerial()}") }
